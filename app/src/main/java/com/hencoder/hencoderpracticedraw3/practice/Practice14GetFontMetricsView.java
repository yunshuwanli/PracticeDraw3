...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float jz = -(fontMetrics.bottom + fontMetrics.top) / 2;

        int middle = (top + bottom) / 2;

        canvas.drawText(texts[0], 100, middle+jz, paint2);
        canvas.drawText(texts[1], 200, middle+jz, paint2);
        canvas.drawText(texts[2], 300, middle+jz, paint2);
        canvas.drawText(texts[3], 400, middle+jz, paint2);
        canvas.drawText(texts[4], 500, middle+jz, paint2);
        canvas.drawText(texts[5], 600, middle+jz, paint2);
    }
}
