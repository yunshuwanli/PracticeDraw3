...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float first = paint1.measureText(text1);
        float second = paint2.measureText(text2);
        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 + first, 200, paint2);
        canvas.drawText(text3, 50 + first + second, 200, paint1);
    }
}
